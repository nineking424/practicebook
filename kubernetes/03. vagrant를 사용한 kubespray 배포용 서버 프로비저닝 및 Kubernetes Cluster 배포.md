...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "nkc-kubespray" do |cfg|
    ...
    cfg.vm.provision "shell", inline: <<-SHELL
      ...
      sshpass -p yourpassword ssh -T -o StrictHostKeyChecking=no 192.168.0.211 "echo '$key_val' >> /root/.ssh/authorized_keys"
      sshpass -p yourpassword ssh -T -o StrictHostKeyChecking=no 192.168.0.221 "echo '$key_val' >> /root/.ssh/authorized_keys"
      sshpass -p yourpassword ssh -T -o StrictHostKeyChecking=no 192.168.0.222 "echo '$key_val' >> /root/.ssh/authorized_keys"
      # kubaspray
      cd /root
