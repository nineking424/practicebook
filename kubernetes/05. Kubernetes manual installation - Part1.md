...
## kubelet 설정 변경 추가 반영!!
- vagrant로 생성한 vm은 기본 network adaptor가 NAT로 잡히기 때문에, INTERNAL-IP가 모두 NAT 기본 IP로 생성됨
...
● kubelet.service - kubelet: The Kubernetes Node Agent
  ...
  Drop-In: /usr/lib/systemd/system/kubelet.service.d
           └─10-kubeadm.conf
   Active: active (running) since Sun 2021-08-15 09:23:47 UTC; 5h 42min ago
...
```
--node-ip 추가
```conf
...
kubemaster1   Ready    control-plane,master   5h51m   v1.22.0   192.168.0.231   <none>        CentOS Linux 7 (Core)   3.10.0-1160.36.2.el7.x86_64   docker://20.10.8
kubeworker1   Ready    <none>                 5h48m   v1.22.0   192.168.0.241   <none>        CentOS Linux 7 (Core)   3.10.0-1160.36.2.el7.x86_64   docker://20.10.8
kubeworker2   Ready    <none>                 5h48m   v1.22.0   192.168.0.242   <none>        CentOS Linux 7 (Core)   3.10.0-1160.36.2.el7.x86_64   docker://20.10.8
```
